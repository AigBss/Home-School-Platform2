          ...
          <el-menu :default-openeds="['1', '3']"
            ...
            <el-sub-menu index="1">
              ...
              <el-menu-item-group title="班级聊天">
                ...
                <el-menu-item index="1-4">创建班级</el-menu-item>
                <el-menu-item index="1-5">加入班级</el-menu-item>
              </el-menu-item-group>
            </el-sub-menu>
            <el-sub-menu index="2">
              <template #title>
            ...
            <el-sub-menu index="3">
              <template #title>
                <el-icon><icon-menu /></el-icon>课表
              </template>
              <el-menu-item index="3-1">所有课表</el-menu-item>
              <el-menu-item index="3-2">发布课表</el-menu-item>
            </el-sub-menu>
            <el-sub-menu index="4">
              <template #title>
                <el-icon><icon-menu /></el-icon>成绩
              </template>
              <el-menu-item index="4-1">班级成绩</el-menu-item>
              <el-menu-item index="4-2">成绩分析</el-menu-item>
              <el-menu-item index="4-3">上传成绩</el-menu-item>
            </el-sub-menu>
            <el-sub-menu index="5">
              <template #title>
